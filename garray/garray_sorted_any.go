...
func (a *SortedArray) PopRand() (value interface{}, found bool) {
	a.mu.Lock()
	defer a.mu.Unlock()
	return a.doRemoveWithoutLock(int(grand.Intn(int64(len(a.array)))))
}
...
func (a *SortedArray) PopRands(size int) []interface{} {
	...
	for i := 0; i < size; i++ {
		array[i], _ = a.doRemoveWithoutLock(int(grand.Intn(int64(len(a.array)))))
	}
	return array
}
...
func (a *SortedArray) Rand() (value interface{}, found bool) {
	...
	return a.array[grand.Intn(int64(len(a.array)))], true
}
...
func (a *SortedArray) Rands(size int) []interface{} {
	...
	array := make([]interface{}, size)
	for i := 0; i < size; i++ {
		array[i] = a.array[grand.Intn(int64(len(a.array)))]
	}
	return array
}
